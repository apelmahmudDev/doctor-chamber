    ...
    return (
        <div>
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <NavLink className="nav-item nav-link" to="/dashboard/dashboard">Dashboard</NavLink>
                <NavLink className={`nav-item nav-link text-${isAppointment?'secondary':'light'}`} to="/services">Dental Services</NavLink>
